...
<title>视频日志#4: 免费送GoPro相机 / “ 冲钻GoGo购 ”</title>
...
<div class="row clearfix">
		<div class="col-md-12 column">
			<ul class="breadcrumb">
				...
				<li>
					 <a href="/media.php#nr">视频日志</a>
				</li>
				<li class="active">
					<h1 >视频日志#4: 免费送GoPro相机 / “ 冲钻GoGo购 ”</h1>
				</li>
...
<iframe height=100% width=100% src="http://player.youku.com/embed/XMTM5MzQ2OTE0MA==" frameborder=0 allowfullscreen></iframe>      </div>
		</div>
