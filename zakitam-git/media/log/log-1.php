...
<title>视频日志#1: 10.11一周视频更新安排</title>
...
<div class="row clearfix">
        ...
        <iframe width="100%" height="100%" src="http://player.youku.com/embed/XMTM1NzU4Mzg4MA==" frameborder=0 allowfullscreen></iframe>
      </div>
		</div>
